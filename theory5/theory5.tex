...
deleteVertex() ends up taking \BigO{m}. Identifying and deleting the node itself
is \BigO{1}, it's constant to remove it from the hash table, and \BigO{n} to
remove it from the array and compact the array (this could be \BigO{1} if we
